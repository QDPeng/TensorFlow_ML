...
# Margin term in loss
classification_term = tf.reduce_mean(tf.maximum(0., tf.subtract(1., tf.subtract(model_output, y_target))))
# Put terms together
loss = tf.add(classification_term, tf.subtract(alpha, l2_norm))
